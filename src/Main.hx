class Main {
	...
	static function initialize() {
        ...
        globals.exits[0]  = ["Living Room",     null,           null];
        globals.exits[3]  = ["Outside",         null,           null];
        globals.exits[4]  = ["Balcony",         null,           null];
        ...
        globals.exits[12] = ["The Street"       null,           null];
        globals.exits[13] = ["Back Hall"        null,           null];
        globals.exits[14] = ["Dance floor",     null,           null];
        globals.exits[15] = ["Restroom",        null,           null];
        globals.exits[16] = ["Bar",             null,           null];
        globals.exits[17] = ["Dance floor",     null,           null];
        globals.exits[18] = ["Stage",           null,           null];
        globals.exits[19] = ["Balcony",         null,           null];
        globals.exits[20] = ["Lounge",          null,           null];
        globals.exits[21] = ["N Main St",       null,           null];
        globals.exits[22] = ["Street",          null,           null];
        globals.exits[23] = ["Hospital",        null,           null];
        globals.exits[24] = ["Pharmacy",        null,           null];
        globals.exits[25] = ["Waiting Room",    null,           null];
        globals.exits[26] = ["Store",           null,           null];
        globals.exits[27] = ["Outside",         null,           null];
        globals.exits[28] = ["Gym",             null,           null];
        globals.exits[29] = ["Workout",         null,              0];
        globals.exits[30] = ["Reception",       null,           null];
        globals.exits[31] = ["Gold Room",       null,              1];
        globals.exits[32] = ["Staff Room",      null,              2];
        globals.exits[33] = ["Restroom",        null,           null];
        globals.exits[34] = ["Showers",         null,           null];
        globals.exits[35] = ["Ice Cream",       null,           null];
        globals.exits[36] = ["Street",          null,           null];
        globals.exits[37] = ["Backroom",        null,              4];
        globals.exits[38] = ["Storefront",      null,           null];
        globals.exits[39] = ["Freezer",         null,           null];
        globals.exits[40] = ["Restroom",        null,           null];
        globals.exits[41] = ["Office",          null,           null];
        globals.exits[42] = ["Warehouse",       null,              5];
        globals.exits[43] = ["Storefront",      null,           null];
        globals.exits[44] = ["Backroom",        null,           null];
